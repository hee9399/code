		...
		<!-- 
			부트스트랩 : 미리 만들어진  css/js 빠르게 적용
				- 설치/적용 cdn
					...
					1. .container : 반응형 구역
					2. 그리드 : 해당 구역 12조각 (화면 구역을 조각단위로 배치하는방식)
						.row		:	하위 요소 가로배치
						.col		:	열 
						.col-조각수	:	열-그리드수
						.justify-content-md-center : 가로배치에 대한 가로정렬
						.g-여백수 	:	열마다 자오여백[24px]	g-0[열 여백제거]
		...
		<table class="table table-striped table-hover table-bordered text-center" >	<!-- 테이블 -->
			...
			<tbody>
				<tr> <!-- 게시물 1개 행 -->
					...
					<td>2023-07-06</td> <td>321</td> <td>2</td>
				</tr>
...
<!-- 검색 창 구역 -->
<div class="row justify-content-md-center gx-1"> <!-- 구역마다 12조각 -->
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true"  >
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="1000" >
      <img src="../img/heard_logo1.jpg" class="d-block w-100" alt="...">
    </div>
