...
public class Ex1_예제 {
	public static void main(String[] args) {
		...
		// 4. set/list 와 for문 관계 [ 배열/컬렉션 내 저장된 데이터들을 순회하려고 ]
			// 1. for문	[list 인덱스가 존재하므로 사용 가능하지만 , set 불가능 ]
			...
			// for문을 쓰는이유는? 배열/컬렉션 내 저장된 데이터들을 순회하기 위해서 
			// 순회한다라는거는 안에있는거는 꺼낸다는 것이다.
		// ------------------------------------------------ //
			// 객체내 중복여부 체크
				// 객체가 String이면 sTring 기준으로 중복 제거
				// 객체[String , int ] 가 2개이상의 필드를 가지고 있으면 중복기준 애매
		...
		set2.add(new Member("홍길동", 24)); // 이름만 중복
		...
		// 4. forEach ( iterator 를 사용하는 컬렉션프레임워크의 객체이면 사용 가능 )
